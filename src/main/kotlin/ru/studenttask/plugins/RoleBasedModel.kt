...
class RoleBasedModel(config: Configuration) {
    ...
    companion object Feature : ApplicationFeature<ApplicationCallPipeline, Configuration, RoleBasedModel> {
        override val key = AttributeKey<RoleBasedModel>("RoleBasedAuthorization")
        ...
        override fun install(
            ...
            return RoleBasedModel(configuration)
        }
...
private fun Route.authorizedRoute(
    ...
    application.feature(RoleBasedModel).interceptPipeline(authorizedRoute, any, all, none)
